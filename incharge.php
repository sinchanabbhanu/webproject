	...
	<section class="ftco-section">
		<div class="container">
			...
			<div class="row">
                ...
                $sql="select v.vname,v.venueid,b.edate,b.start,b.end,b.requestedby,b.department from booking b,venues v where b.venueid=v.venueid and inchargeApproval='pending';";
          ...
          while($row = $result->fetch_assoc()) {
            ...
            $dept=$row['department'];
            $by=$row["requestedby"];
          echo '<tr class="alert" role="alert" ><form action="" method="post"><td scope="row">'.'<input type="text" name="vname"  value="'.$vname.'"readonly></td><td scope="row">'.'<input type="text" name="date" value="'.$date.'" readonly></td><td><input type="text"  name="start" value="'.$start.'" readonly></td><td><input type="text" name="end" value="'.$end.'"readonly></td><td><input type="text"  name="by" value="'.$by.'" readonly></td><td><input type="text" name="dept"  value="'.$dept.'" readonly></td><td>'.'<input class="incharge" type="submit" name="approve" value="Approve"></td></form></tr>';
          }
          }
          else {
          echo "0 results";
        ...
        {  $vname=$_POST['vname'];
          ...
          $start=$_POST['start'];
          $end=$_POST['end'];
$sql1="update booking set inchargeApproval='approved' where vname='$vname' and edate='$date' and start=$start and end=$end;";
